...
*/
/*
- az element javascript reprezentáiója: document.getElementById('element-one')
- esemény kiválasztása: onclick
- funkcionalitás leírás : function () {...}

stackoverflow -> itt vannak a legjobb inform,ációk fejelsztőknek
*/

//console.log(document.getElementById("element-one"));
//console.dir(document.getElementById("element-one"));

//belső állapot: state kell
var isBlurred = false;
//action (esemény)
...
document.getElementById("element-three").ondblclick = function (){
    document.getElementById("element-three").firstElementChild.innerHTML = getRandomArbitrary(1, 88)
}
/*
4. doboz:
...
document.onmousemove = function(event){
    ...
    document.getElementById('element-seven').firstElementChild.innerHTML = coordinates;
